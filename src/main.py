...
try:
    som_nave_colisao = pygame.mixer.Sound(os.path.join(BASE_DIR, 'assets', 'sounds', 'som_nave_colisao.wav'))
except Exception as e:
    som_nave_colisao = None
try:
    som_missil = pygame.mixer.Sound(os.path.join(BASE_DIR, 'assets', 'sounds', 'som_missil.wav'))
except Exception as e:
    som_missil = None
try:
    som_explosao = pygame.mixer.Sound(os.path.join(BASE_DIR, 'assets', 'sounds', 'som_explosao.wav'))
except Exception as e:
    som_explosao = None

# Carregamento e inserção de Imagens na Janela.
try:
    bg = pygame.image.load(os.path.join(BASE_DIR, 'assets', 'images', 'imagem_fundo.jpg'))
    bg = pygame.transform.scale(bg, (x, y)) # Garante que o fundo ocupe toda a tela
    nave_principal = pygame.image.load(os.path.join(BASE_DIR, 'assets', 'images', 'nave_player.png'))
    nave_inimiga = pygame.image.load(os.path.join(BASE_DIR, 'assets', 'images', 'nave_inimiga.png'))
    tiro = pygame.image.load(os.path.join(BASE_DIR, 'assets', 'images', 'missil_pequeno.png'))
